    ...
    <div class="container">
                    ...
                    <div class="modal-body">
                        <form action="#" method="post" id="pelanggan">
                            ...
                            <input type="text" name="nama" placeholder="Masukkan Nama" id="nama"
                                oninvalid="this.setCustomValidity('Silahkan Masukkan Nama Anda')" accept=""
                                oninput="this.setCustomValidity('')" required="require">

                            <input type="number" name="tlp" placeholder="Masukkan Nomor Handphone (Dalam Angka)"
                                id="tlp" oninvalid="this.setCustomValidity('Silahkan Masukkan Nomor Handphone')"
                            ...
                            <input type="text" name="email" placeholder="Masukkan Email (Optional)" id="email"
                                oninvalid="this.setCustomValidity('Silahkan Masukkan Email Anda')" accept=""
                                oninput="this.setCustomValidity('')">

                            <input type="number" name="ktp" placeholder="Masukkan No KTP" id="ktp"
                                oninvalid="this.setCustomValidity('Silahkan Masukkan Nomor KTP Anda')" accept=""
                                oninput="this.setCustomValidity('')" required="require">
                            ...
                            <div class="input-date">
                                ...
                                <label>Hari : <input type="number" class="tgl" name="hari" id="hari"
                                        ...
                                        accept="" oninput="this.setCustomValidity('')" required="require" min="1"
                                        max="31"></label>
                                ...
                                <label>Tahun : <input type="number" class="tgl" name="tahun" id="tahun"
                                        ...
                                        accept="" oninput="this.setCustomValidity('')" required="require" min="1800"
                                        max="3000"></label>
                            </div>

                            <label>Jenis Kelamin : </label>
                            <label class="radio-inline"><input type="radio" name="jk" id="jk" value="L"> Laki-laki
                            </label>
                            <label class="radio-inline"><input type="radio" name="jk" id="jk" value="P"> Perempuan
                            </label>
                            <br>
                            <div class="center">
                                <input type="button" name="update" id="update" ktp="" class="btn-mod btn-submit"
                                    value="Update / Submit">
                                <input type="button" name="hapus" id="hapus" ktp="" class="btn-mod btn-sub-nav"
                                    value="Hapus Data">
                            </div>
        ...
        <div class="text-center" <?php if($total_pages == 1){ echo " hidden"; }?>>
            <ul class="pagination">
                ...
                <li id="back_page">
                    <a href="#" data-id="" class="page-link" id="bp">
                        < </a>
                </li>
                <?php
                ...
                <li class="pageitem active" id="<?php echo $i;?>">
                    <a href="#page_no=<?php echo $i;?>" data-id="<?php echo $i;?>"
                        class="page-link active"><?php echo $i;?></a>
                </li>
                <?php 
                            }
                            else
                ...
                <li class="pageitem" id="<?php echo $i;?>">
                    <a href="#page_no=<?php echo $i;?>" class="page-link active"
            ...
            success: function(data) {
                ...
                for (count; count < data.length; count++) {
                    ...
                    if (data[count].verifikasi == 0) {
                        html += '<input type="button" name="ver" id="ver" ktp="' + data[count].ktp +
                            '" email="' + data[count].email + '" tlp="' + data[count].tlp +
                            '"value="Verifikasi" class="btn btn-info pull-left">';
                    } else {
                        html += '<input type="button" name="ver" id="ver" ktp="' + data[count]
                            .email + '" email="' + data[count].email + '" tlp="' + data[count].tlp +
                            '"value="Verif Lagi" class="btn btn-danger pull-left">';
                    }
                    ...
                    html +=
                        '<input type="button" data-toggle="modal" data-target="#peserta_modal" id_s="' +
                        data[count].id + '" ktp="' + data[count].ktp + '" \n\
                                nama="' + data[count].nama + '" tlp="' + data[count].tlp + '" email="' + data[count]
                        .email + '" tgl="' + data[count].tgl + '"\n\
                                hari="' + hari + '" bulan="' + bulan + '" tahun="' + tahun + '" jk="' + data[count]
                        .jk + '"\n\
